...
public class AuthorsFilterVisitor implements IRecordFilteringVisitor
{
    ...
    public List<Entry> visitAndFilter(List<Entry> source, String filter)
    {
        ...
        for(Entry entry : source)
        {
            ...
            {
                List<String> entryAuthors = getAuthorsSurnames(getAuthorsList(entry.getRequiredAttributes().get("author")));
            ...
            else if (entry.getOptionalAttributes().containsKey("author"))
            {
                List<String> entryAuthors = getAuthorsSurnames(getAuthorsList(entry.getOptionalAttributes().get("author")));
