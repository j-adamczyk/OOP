...
import parser.IStringSubstituterStrategy;
...
public class testDefaultStringSubstituter
{
    ...
    {
        UtilSingleton.getInstance().setOriginalText("@STRING{ deleteMe = \"_\" }\n"+
        "@STRING{ subst = \"aaa\"} \n"+
        "@BOOK{KeydeleteMe_no13,\nauthor = \"and\"subst\n}\n");

        UtilSingleton.getInstance().setSubstitutedText(UtilSingleton.getInstance().getOriginalText());
