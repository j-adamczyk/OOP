...
public class CommandParameterValueAtTime implements ICommand
{
     ...
     */
    public void execute(String stationName, String parameter, String dateAndTime)
    {
        ...
        try
        {
            this.paramValue = UtilSingleton.getInstance().getEntries().
                    get(stationName).getParameterMeasurements().get(parameter).get(dateAndTime);
        }
