...
public class API_GIOS implements IAPIStrategy
{
    ...
    /**
     * Method required by IAPIStrategy interface, return all information from API as properly formatted Entry list.
     * @return list of all information from API as Entry list
    ...
    public List<Entry> getInfo() throws CommunicationException
    {
        ...
        for (Station station : stations)
        {
            executorService.execute(() ->
            {
                ...
                entry.parameterMeasurements = new HashMap<>();

                for (Sensor sensor : sensors)
                    entry.parameterMeasurements.put(sensor.param.paramCode, getSensorMeasurements(sensor.id.toString()));

                AirIndexOutside airIndex = getAirIndex(station.id.toString());

                AirIndex airIndexCache = new AirIndex();

                airIndexCache.stIndexLevel = (airIndex.stIndexLevel != null) ? airIndex.stIndexLevel.indexLevelName : "-";
                airIndexCache.so2IndexLevel = (airIndex.so2IndexLevel != null) ? airIndex.so2IndexLevel.indexLevelName : "-";
                airIndexCache.no2IndexLevel = (airIndex.no2IndexLevel != null) ? airIndex.no2IndexLevel.indexLevelName : "-";
                airIndexCache.coIndexLevel = (airIndex.coIndexLevel != null) ? airIndex.coIndexLevel.indexLevelName : "-";
                airIndexCache.pm10IndexLevel = (airIndex.pm10IndexLevel != null) ? airIndex.pm10IndexLevel.indexLevelName : "-";
                airIndexCache.pm25IndexLevel = (airIndex.pm25IndexLevel != null) ? airIndex.pm25IndexLevel.indexLevelName : "-";
                airIndexCache.o3IndexLevel = (airIndex.o3IndexLevel != null) ? airIndex.o3IndexLevel.indexLevelName : "-";
                airIndexCache.c6h6IndexLevel = (airIndex.c6h6IndexLevel != null) ? airIndex.c6h6IndexLevel.indexLevelName : "-";

                entry.airIndex = airIndexCache;
     ...
     * @throws CommunicationException if there was a problem connecting to the Internet or GIOS site
     */
    List<Station> getStations () throws CommunicationException
    {
     ...
     */
    List<Sensor> getSensors (String stationID)
    {
     ...
     */
    Map<String,Double> getSensorMeasurements (String sensorID)
    {
     ...
     */
    AirIndexOutside getAirIndex (String stationID)
    {
